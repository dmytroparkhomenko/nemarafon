  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-center text-center my-6 gap-2">
        ...
        <div className="flex flex-col">
          <h3 className="uppercase text-marine font-light mb-2 text-xl md:text-2xl font-titles md:text-left text-center">
            Для мене тіло – єдиний Всесвіт
          </h3>
          <p className="text-white normal-case text-base md:text-lg font-light leading-tight">
            Безрезультатні тренування більше нікому не потрібні. З моїм
            індивідуальним підходом ви нарешті побачите результат і отримаєте
            тіло своєї мрії
          </p>
        </div>
      </div>
      <div className="flex flex-col md:flex-row items-center text-center my-6 gap-2">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-white normal-case text-base md:text-lg font-light leading-tight">
            Перед початком роботи я вивчаю ваш організм як зсередини, так і
            ззовні. Розшифровую аналізи, надаю рекомендації щодо необхідних
            мікроелементів, підбираю індивідуальний план харчування
          </p>
        </div>
      </div>
    </>
